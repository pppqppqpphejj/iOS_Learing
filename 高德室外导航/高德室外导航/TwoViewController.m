...
//#import "SerchTwoViewController.h"
#import "InMapView.h"
...
@class PointD;
@interface TwoViewController ()<IndoorMapViewDelegate,IndoorDataMangerProtocol,UIActionSheetDelegate,UITextFieldDelegate,IndoorFloorHBarDelegate>
{
...
- (void)viewDidLoad {
    ...
    self.mapView = [[IndoorMapView alloc] initWithFrame:self.view.frame];
//    self.mapView.backgroundColor = [UIColor clearColor];
    ...
    self.textHight = [self initContentHightFloat:18.00f andText:_toplLable.text andWidth:self.view.frame.size.width-40];
    ...
    button.frame = CGRectMake(0, self.view.frame.size.height-100, 30, 30);
...
-(void)didTapClick:(IndoorMarkerView *)idoorMView
{
    ...
    if (!isHidden) {
        _poiView = [[UIView alloc]initWithFrame:CGRectMake(0,-self.view.frame.size.height, 0, self.view.frame.size.width)];
...
//    SerchTwoTwoViewController *SerchViewC = [[SerchTwoViewController alloc]initWithNibName:@"SerchTwoViewController" bundle:nil];
//        //    spc.selMarkView = self.selMarkView;
//        //    spc.userLocation = self.userLocation;
//        //    spc.spoid = self.spoiid;
//    UIBarButtonItem *barButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"" style:UIBarButtonItemStyleDone target:nil action:nil];
//    self.navigationItem.backBarButtonItem = barButtonItem;
//    [self.navigationController pushTwoViewController:SerchViewC animated:YES];
}
